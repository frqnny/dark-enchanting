...
public class DarkEnchanterBlock extends BlockWithEntity {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (world.isClient) {
            ...
            MenuRegistry.openExtendedMenu((ServerPlayerEntity) player, (DarkEnchanterBlockEntity) world.getBlockEntity(pos));
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? validateTicker(type, ModBlocks.DE_BLOCK_ENTITY.get(), DarkEnchanterBlockEntity::tick) : null;
    }
